...
def outplot(Matrix, age_lst, SqFtLiving, Bedrooms):
    ...
    ax2.plot(ES_Rate, 'gs', label='Elementary School', markersize=13, alpha=0.7)
    ax2.plot(MS_Rate, 'r^', label='Middle School', markersize=13, alpha=0.7)
    ax2.plot(HS_Rate, 'bo', label='High School', markersize=13, alpha=0.7)
